  ...
  )
{
  ...
  ShellCommandRegisterCommandName(L"embeddedramdisk", ShellCommandRunEmbeddedRamdisk  , ShellCommandGetManFileNameDebug1, 0, L"Debug1", TRUE, gShellDebug1HiiHandle, STRING_TOKEN(STR_GET_HELP_EMBEDDEDRAMDISK) );
